...
data = data.drop(columns = ["id","EmployeeCount","Over18","StandardHours","WorkLifeBalance","Education","EnvironmentSatisfaction","JobLevel","PercentSalaryHike","YearsWithCurrManager","StockOptionLevel","MonthlyRate","RelationshipSatisfaction","DailyRate","HourlyRate","JobSatisfaction"], axis = 1)
...
def prediction_rand():
  st.title("Employee Attrition Prediction With Random Forest Classifier")
...
#  ========making prediction============
  if st.button("Make Prediction"):
    prediction = pipeline_rand.predict(user_input)
